        ...
        <nav id="botonera-login" class="contenedor-interno"> 
            ...
            <ul>
               ...
               <li>
                    ...
                    <a href="micarrito.php" style="text-align: center;"><span id="cant_carrito"><?consultar_cant_carrito();?></span></a>                </li>
            </ul>               
        </nav>
...
<!--                <ul>
                        <li <? if ($body=='home') echo $class;?> ><a href="<?=$index_url?>" title="Home">HOME</a></li>
                        <li class="pipe">|</li>
                        <li <? if ($body=='empresa') echo $class;?> ><a href="empresa.php" title="Empresa">EMPRESA</a></li>
                        <li class="pipe">|</li>
                        <li <? if ($body=='donde_estamos') echo $class;?> ><a href="donde_estamos.php" title="Donde Estamos">DONDE ESTAMOS</a></li>
                        <li class="pipe">|</li>
                        <li <? if ($body=='contacto') echo $class;?> ><a href="javascript:;" class="consultas">CONTACTO</a></li>
                    </ul>       -->            
                </nav>
<!--                 <nav id="botonera-iconos">
                    ...
                    <div class="botones">
                        <figure class="boton">
                            ...
                            <a href="micarrito.php" style="text-align: center;"><span id="cant_carrito"><?consultar_cant_carrito();?></span><br>Carrito</a>
                        </figure>
                        <figure class="boton">
...
<?if(strtolower($archivo_actual)=='index.php'){
